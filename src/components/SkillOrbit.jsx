...
const SKILLS = [
  ...
  { label: 'Java', size: 30, color: '#f59e0b' },
  { label: 'Django', size: 32, color: '#0ea572' },
  { label: 'React', size: 30, color: '#06b6d4' },
  { label: 'JavaScript', size: 30, color: '#eab308' },
  { label: 'Machine Learning', size: 34, color: '#10b981' },
  { label: 'Deep Learning', size: 34, color: '#0ea572' },
  { label: 'TensorFlow', size: 32, color: '#f97316' },
  { label: 'PyTorch', size: 32, color: '#ef4444' },
  { label: 'Keras', size: 26, color: '#ec4899' },
  { label: 'CNN', size: 26, color: '#06b6d4' },
  { label: 'RNN', size: 24, color: '#8b5cf6' },
  { label: 'Transformers', size: 30, color: '#a855f7' },
  { label: 'NLP', size: 28, color: '#14b8a6' },
  { label: 'AI', size: 38, color: '#10b981' },
  { label: 'Speech Recognition', size: 28, color: '#0ea572' },
  { label: 'Computer Vision', size: 28, color: '#10b981' },
  { label: 'HTML/CSS', size: 26, color: '#f97316' },
  { label: 'MySQL', size: 26, color: '#f59e0b' },
  { label: 'Git', size: 24, color: '#ef4444' },
  { label: 'REST APIs', size: 24, color: '#06b6d4' },
  { label: 'WordPress', size: 24, color: '#3b82f6' },
  { label: 'C', size: 22, color: '#6366f1' },
];
